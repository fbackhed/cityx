...
export default function Home() {
  return (
    <div className={styles.container}>
      ...
      <li><a href="/https://city-xxx.com/">City X</a></li><li><a href="/about">About</a></li><li><a href="http://city-x.bandcamp.com">Bandcamp</a></li>  <a href="https://soundcloud.com/cityxxx">Soundcloud</a>
        </h1>
